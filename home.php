        ...
        <div class="row">
            ...
            <div class="col-md-4 right">
                <div id="advertisements" style="min-height: 500px;">
                    ...
                    <!--                    <div class="explorer" id="pagexplorer">-->
                    <!---->
                    <!--                    </div>-->
                    ...
                    <div class="container">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="h4" style="font-weight: bold;">Audit trail</div>
                            </div>
...
<!--                                        <li><a href="#" class="prev"><span class="fa fa-chevron-downn"></span></a></li>-->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-cancel"></i>
                            Close
                        </button>
                    </div>
